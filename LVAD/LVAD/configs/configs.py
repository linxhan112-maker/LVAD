...
def get_configs_avenue():
    ...
    config.run_type = 'inference' #inference
    config.resume = False
    ...
    config.avenue_path = "/media/lmy/processing/han/data/avenue"
    config.avenue_gt_path = "/media/lmy/processing/han/data/test_gt"
    config.percent_abnormal = 0.25
    config.input_3d = False
    config.device = "cuda"
...
def get_configs_shanghai():
    ...
    config.shanghai_path = "/media/Shanghai"
    config.shanghai_gt_path = "/media/Shanghai_gt"
    config.percent_abnormal = 0.25
