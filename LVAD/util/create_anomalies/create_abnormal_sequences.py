            ...
            if "abnormal" in video:
                ...
                for t, track in enumerate(tracks):
                    ...
                    for i, frame in enumerate(selected_frames):
                        ...
                        cv2.imwrite(os.path.join(self.store_dir_sequences, video, f"sequence_{t:04d}", "anomalies", f"{i}medium.png"), anomaly)
                        cv2.imwrite(os.path.join(self.store_dir_sequences, video, f"sequence_{t:04d}", "masks", f"{i}medium.png"), mask)